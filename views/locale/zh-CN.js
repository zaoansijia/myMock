  ...
  p: {
    ...
    detail: {
      ...
      expand: {
        description: '描述',
        tab: ['请求参数', '响应参数'],
        columnsRequest: ['参数名', '描述', '参数类型', '数据类型', '是否必须', '操作', '父级'],
    ...
    server: {
      nav: ['服务器地址集合', '新增/编辑'],
      title: ['服务器地址', '开发人员的服务器地址，如果有更改请及时更新'],
      column: ['项目展示名','项目保存名', '服务器名', '服务器地址', '转发地址', '是否选中', '操作'],
      add: {
        success: '添加成功',
        btnTxt: '添加地址'
      },
      ...
      form: {
        project: ['项目展示名 & 项目保存名', '请输入展示的项目名', '项目保存名需为英文字母, eg：小虫后台 & MicroBackstage '],
  ...
  c: {
    ...
    layout: {
      menu: [
        ['我的项目', '个人项目', '团队项目'],
        '工作台', '服务器地址', '文档',
        ['相关链接', 'API 生成工具', 'Mock 语法', '工时系统', '成都研发中心(gome知识库)', 'JIRA', '国美GitLab'],
        ['编辑资料', '退出', '登录']
      ]
    },
    logOut: {
